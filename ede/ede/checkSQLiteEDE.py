      ...
      for i,_incident in enumerate(_queryIncident):
        ...
        if(_incident[5] == 'Entrevista'):
          ...
          if not (_incident[23] == 'Entrevistador' and _incident[25] in ('Docente','Profesional de la educación','Substitute teacher','Personal Administrativo')): 
            print(f"{_incident[23] == 'Entrevistador'} and {_incident[25] in ('Docente','Profesional de la educación','Substitute teacher','Personal Administrativo')} --> {not (_incident[23] == 'Entrevistador' and _incident[25] in ('Docente','Profesional de la educación','Substitute teacher','Personal Administrativo'))}")
