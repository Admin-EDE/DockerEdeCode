...
>>>>>>> c19a28159eb9385924acb3041139d22d53ad6785
    try:
      ...
      _s2 = """SELECT digitalRandomKey,observaciones	
                FROM RoleAttendanceEvent
                WHERE OrganizationPersonRoleId = ?
                AND Date = ?
...
>>>>>>> c19a28159eb9385924acb3041139d22d53ad6785
        ...
        if(len(_l)!=0):
          logger.error(f"los siguientes alumnos presentan registros de modificacion de asistencia sin firma u observacion: {str(_l)}")
          logger.error(f"Rechazado")
          return False
        else:
          logger.info(f"Aprobado")
        ...
        logger.error(f"No hay informacion de registro de asistencia.")
        logger.error(f"Rechazado")
        return False
